...
public class DefaultHttp2ConnectionEncoder implements Http2ConnectionEncoder, Http2SettingsReceivedConsumer {
    ...
    public Future<Void> writeSettingsAck(ChannelHandlerContext ctx) {
        ...
        PromiseNotifier.cascade(frameWriter.writeSettingsAck(ctx), aggregator.newPromise());
    ...
    private final class FlowControlledData extends FlowControlledBase {
        ...
        public void write(ChannelHandlerContext ctx, int allowedBytes) {
            ...
            // Write the frame(s).
            PromiseNotifier.cascade(frameWriter().writeData(ctx, stream.id(), toWrite, writablePadding,
